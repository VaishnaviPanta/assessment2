...
ActiveRecord::Schema[7.1].define(version: 2024_07_26_072923) do
  ...
  create_table "teams", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "home_team_id"
    t.integer "away_team_id"
    t.index ["away_team_id"], name: "index_teams_on_away_team_id", unique: true
    t.index ["home_team_id"], name: "index_teams_on_home_team_id", unique: true
